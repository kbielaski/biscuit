...
struct RecipeDetailView: View {
    ...
    @State private var editableIngredients: [IngredientGroup] = sampleRecipes[0]
        .ingredients
    @State private var isTitleEditable: Bool = true
                    ...
                    VStack {
                        ...
                        HStack {
                            ForEach(0..<5) { index in
                                Image(
                                    systemName: index < Int(editableRating)
                                        ? "star.fill" : "star"
                                )
                                .foregroundColor(
                ...
                ZStack {
                    VStack {
                        ...
                        Group {
                            if selectedTab == 0 {
                                IngredientsView(
                                    ingredientGroups: $editableIngredients,
                                    editMode: editMode
                                )
